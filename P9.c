/*BCSL404 Program 9*/
/*9.sort a given set of n integer elements using Selection Sort method and
 * compute its time complexity. Run the program for varied values of n> 5000 and
 * record the time taken to sort. Plot a graph of the time taken versus n. The
...
time_taken = [0.031000, 0.034000, 0.047000, 0.052000, 0.077000]  # replace with
