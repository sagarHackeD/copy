/*BCSL404 Program 10*/
/*10.sort a given set of n integer elements using Quick Sort method and compute
 * its time complexity. Run the program for varied values of n> 5000 and record
 * the time taken to sort. Plot a graph of the time taken versus n. The elements
...
time_taken = [0.0000, 0.015000, 0.011000, 0.003000, 0.015000]  # replace with
